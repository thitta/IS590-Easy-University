# Generated by Django 2.1.5 on 2019-03-18 01:16
...
class Migration(migrations.Migration):
    dependencies = [
        ('courseinfo', '0005_year_shcema_and_data_migration'),
    ]

    operations = [

        # STEP_1. forward modify schema: add new columns
        ...
        # STEP_3. forward modify schema: set schema
